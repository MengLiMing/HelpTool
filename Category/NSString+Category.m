...
- (NSAttributedString *)stylegoalColor:(UIColor *)goalColor
    ...
    [str addAttributes:@{NSForegroundColorAttributeName:goalColor} range:range];
    [str addAttributes:@{NSForegroundColorAttributeName:otherColor} range:NSMakeRange(0, range.location)];
    [str addAttributes:@{NSForegroundColorAttributeName:otherColor} range:NSMakeRange(range.location + range.length, self.length - range.location - range.length)];
